    ...
    <div className="bg-gray-100 py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-16">
          ...
          to meaningful conversations with experts from diverse industries.
          Whether it’s{" "}
          ...
          , or{" "}
          <span className="text-yellow-600 font-semibold">career guidance</span>
          , Peepal connects you with professionals who can provide real-time{" "}
          insights and actionable advice. No more searching through endless
          online tutorials—find the right people and{" "}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md flex flex-col items-center justify-center">
            ...
            <p className="text-center">
              Have meaningful conversations with industry professionals.
            </p>
          </div>
        </div>
      </div>
