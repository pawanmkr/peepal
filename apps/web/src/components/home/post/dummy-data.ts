...
export const tutors: Tutor[] = [
  {
    id: "1",
    description: "Experienced tutor specializing in problem-solving skills.",
    experience: 10,
...
export const posts: Post[] = [
  ...
  },
  {
    ...
    description: "Get familiar with basic calculus concepts in this session.",
    date: "2024-07-10",
    views: 920,
    tutor: tutors[1],
  },
  ...
  },
  {
    ...
    description: "Enhance your logical reasoning by solving complex puzzles.",
    date: "2024-07-20",
    views: 1450,
    tutor: tutors[0],
  },
...
export const topics: Topic[] = [
  ...
  {
    name: "Crochet",
    benefits: ["Creates handmade items", "Reduces stress", "Improves focus"],
  ...
  {
    name: "Upcycling",
    benefits: ["Reduces waste", "Enhances creativity", "Creates unique items"],
