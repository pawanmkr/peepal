...
const ProfessionalSearch: React.FC<{ query: string }> = ({ query }) => {
    const LIMIT = 25; // Number of results per page
    const [professionals, setTutors] = useState<Professional[]>([]); // State to store the list of professionals
    ...
    const handleSearch = async (searchQuery: string) => {
        ...
        setLoading(true);
        let res = await professionalApi.searchProfessionals(
            searchQuery,
            ...
            <div className="flex-grow max-w-3xl mx-auto w-full">
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        {/* Display the list of professionals */}
